...
public class PortalController(AppDb db, IProductSearchService productSearch, IOrderRuleService rules, IFulfillmentGateway fulfillment) : ControllerBase
{
    ...
    [HttpGet("accounts/search")] public async Task<object> SearchAccounts([FromQuery] string? q = "", [FromQuery] int limit = 10) { var query = Normalize(q ?? ""); var accounts = db.Accounts.AsNoTracking().AsQueryable(); if (query.Length > 0) { var pattern = $"%{query.Replace("%", "[%]").Replace("_", "[_]")}%"; accounts = accounts.Where(a => EF.Functions.Like(a.Id, pattern) || EF.Functions.Like(a.Name, pattern) || EF.Functions.Like(a.AccountNumber, pattern) || EF.Functions.Like(a.City, pattern)); } return await accounts.OrderBy(a => a.Name).Take(Math.Clamp(limit, 1, 20)).ToListAsync(); }
    ...
    [HttpGet("products/search-by-name")] public async Task<object> ProductsByName([FromQuery] string? q = null, [FromQuery] string? query = null, [FromQuery] string? shipToAccountId = null, [FromQuery] bool favorites = false, CancellationToken ct = default) => (await productSearch.SearchByNameAsync(query ?? q, favorites, null, ct)).Products;
    [HttpGet("products/search-by-item-number")] public async Task<object> ProductsByItemNumber([FromQuery] string? q = null, [FromQuery] string? query = null, [FromQuery] string? shipToAccountId = null, [FromQuery] bool favorites = false, CancellationToken ct = default) => (await productSearch.SearchByItemNumberAsync(query ?? q, favorites, null, ct)).Products;
    [HttpGet("products/search-by-active-ingredient")] public async Task<object> ProductsByActiveIngredient([FromQuery] string? q = null, [FromQuery] string? query = null, [FromQuery] string? shipToAccountId = null, [FromQuery] bool favorites = false, CancellationToken ct = default) => (await productSearch.SearchByActiveIngredientAsync(query ?? q, favorites, null, ct)).Products;
    [HttpGet("products/search")] public async Task<object> Products([FromQuery] string? criterion = "Product Name", [FromQuery] string? q = "", [FromQuery] string? query = null, [FromQuery] string? shipToAccountId = null, [FromQuery] bool favorites = false, CancellationToken ct = default) => (await productSearch.SearchAsync(ProductSearchService.ParseCategory(criterion), query ?? q, favorites, null, ct)).Products;
    [HttpGet("products/name-suggestions")] public Task<object> NameSuggestions([FromQuery] string? q = null, [FromQuery] string? query = null, [FromQuery] string? shipToAccountId = null, [FromQuery] int limit = 10) => Suggestions(q, query, "Product Name", shipToAccountId, limit);
    [HttpGet("products/item-number-suggestions")] public Task<object> ItemNumberSuggestions([FromQuery] string? q = null, [FromQuery] string? query = null, [FromQuery] string? shipToAccountId = null, [FromQuery] int limit = 10) => Suggestions(q, query, "Item Number", shipToAccountId, limit);
    [HttpGet("products/active-ingredient-suggestions")] public Task<object> ActiveIngredientSuggestions([FromQuery] string? q = null, [FromQuery] string? query = null, [FromQuery] string? shipToAccountId = null, [FromQuery] int limit = 10) => Suggestions(q, query, "Active Ingredient", shipToAccountId, limit);
